...
<html lang="zxx"> 
	...
	<body class="defult-home">
		...
		<div class="main-content">
			...
			<div id="rs-slider" class="rs-slider rs-slider-style2 rs-slider-style4">
			    <div class="bend niceties">
			        ...
			        <div id="slide-1" class="slider-direction">
			           <div class="container">
			           		<div class="content-part text-center">
			           		    <span class="sl-subtitle">Welcome To Konstruk</span>
			           		    <h1 class="sl-title">
			           		    	Best Solution For<br>
			           		    	Construction
			           		    </h1>
			           		   	<div class="slider-bottom">
			           		   	    <a class="readon more read2" href="contact.html">Read More</a>
			           		   	</div>
			           		</div>
			           </div>
			        </div>
			        ...
			        <div id="slide-2" class="slider-direction">
			        	<div class="container">
		        			<div class="content-part text-center">
		        			    <span class="sl-subtitle">Building & Construction</span>
		        			    <h1 class="sl-title">
					...
					<div class="row">
						<div class="col-lg-4 col-md-6 mb-60">
							<div class="services-item">
                                ...
                                <div class="services-text">
                                    <h2 class="title"><a href="general-construction.html">General construction</a></h2>
						...
						<div class="col-lg-4 col-md-6 mb-60">
							<div class="services-item">
                                ...
                                <div class="services-text">
                                    <h2 class="title"><a href="property-maintenance.html">Property maintenance</a></h2>
                                    <p class="services-txt">Quisque placerat vitae lacus ut scelerisque. Fusce luctus odio ac nibh luctus consulting.</p>
                                </div>
                            </div>
						</div>
						<div class="col-lg-4 col-md-6 mb-60">
							<div class="services-item">
                                ...
                                <div class="services-text">
                                    <h2 class="title"><a href="project-managment.html">Project managment</a></h2>
                                    <p class="services-txt">Quisque placerat vitae lacus ut scelerisque. Fusce luctus odio ac nibh luctus consulting.</p>
                                </div>
                            </div>
						</div>
						<div class="col-lg-4 col-md-6 md-mb-60">
							<div class="services-item">
                                ...
                                <div class="services-text">
                                    <h2 class="title"><a href="virtual-design-build.html">Virtual design & build</a></h2>
                                    <p class="services-txt">Quisque placerat vitae lacus ut scelerisque. Fusce luctus odio ac nibh luctus consulting.</p>
                                </div>
                            </div>
						</div>
						<div class="col-lg-4 col-md-6 sm-mb-60">
							<div class="services-item">
                                ...
                                <div class="services-text">
                                    <h2 class="title"><a href="preconstruction.html">Preconstruction</a></h2>
                                    <p class="services-txt">Quisque placerat vitae lacus ut scelerisque. Fusce luctus odio ac nibh luctus consulting.</p>
                                </div>
                            </div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="services-item">
                                ...
                                <div class="services-text">
                                    <h2 class="title"><a href="design-build.html">Design build</a></h2>
                                    <p class="services-txt">Quisque placerat vitae lacus ut scelerisque. Fusce luctus odio ac nibh luctus consulting.</p>
                                </div>
                            </div>
						</div>
			...
			<!-- Blog Section Start -->
			<div id="rs-blog" class="rs-blog blog-main-home blog-modify2 bg5 pt-120 pb-115 md-pt-0 md-pb-80">
			    <div class="container">  
			        <div class="row">
			        	<div class="col-lg-6">
			        	...
			        	<div class="col-lg-6">
			        		<div class="btn-part text-right md-left md-mb-50">
                                <a class="readon more discover" href="blog-single.html">View Updates</a>
                            </div>
			        	</div>
			        </div>
