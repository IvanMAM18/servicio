										...
										<div class="main-menu">
											<nav class="rs-menu hidden-md">
												<ul class="nav-menu">
													...
													<li class="menu-item-has-children">
														<a href="https://devsdesign.net/products/html/konstruk/services.html">Services</a>
														<ul class="sub-menu">
			...
			<div id="rs-slider" class="rs-slider rs-slider-style2">
			    <div class="bend niceties">
			        <div id="nivoSlider" class="slides">
			            <img src="assets/images/slider/style1/h1-1.jpg" alt="" title="#slide-1" />
			            <img class="slies-img" src="assets/images/slider/style1/h1-2.jpg" alt="" title="#slide-22" />
			        </div>
			        <!-- Slide 1 -->
			        ...
			        <div id="slide-22" class="slider-direction">
			        	<div class="container-side-slide2">
		        			...
		        			<div class="animation-wrap2">
		        				<div class="animate-style one">
		        					<img class="sl-icons2" src="assets/images/slider/style1/shapes/icons1.png" alt="Images">
		        				</div>
		        				<div class="animate-style two">
		        					<img class="sl-icons2" src="assets/images/slider/style1/shapes/icons2.png" alt="Images">
		        				</div>
		        				<div class="animate-style three">
		        					<img class="sl-icons2" src="assets/images/slider/style1/shapes/icons2.png" alt="Images">
		        				</div>
			    			...
			    			<div class="services-item">
			    				<div class="services-wrap">
			    					<div class="services-image">
			    						<img src="assets/images/services/main-home/main-img/servic-1.jpg.png" alt="Services">
			    					</div>
                    ...
                    <div class="row y-middle">
                        <div class="col-lg-6 md-mb-10 text-lg-end text-center order-last">
                            <ul class="copy-right-menu">
                                ...
                                <li><a href="https://devsdesign.net/products/html/konstruk/services.html">Services</a></li>
